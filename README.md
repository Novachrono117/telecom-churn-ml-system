...
<details>
<summary><b>Verification commands</b> — 11 gates, all exit 0</summary>
...
# this one runs in the serving project, because it imports the API
uv run --project serving python scripts/build_serving_record.py --verify
```

Drop `--verify` to regenerate. `freeze_model.py` rebuilds the pipeline from the frozen
split, builder and training pool; both fingerprints must come out unchanged.
...
| Topic | Document |
| --- | --- |
| Data understanding | [data_understanding.md](reports/data_understanding.md) · [data_dictionary.md](reports/data_dictionary.md) |
| Exploratory analysis | [eda_report.md](reports/eda_report.md) |
| Preprocessing and split | [preprocessing_report.md](reports/preprocessing_report.md) |
| Baselines and features | [baseline_report.md](reports/baseline_report.md) · [feature_engineering_report.md](reports/feature_engineering_report.md) |
| Model selection | [model_comparison_report.md](reports/model_comparison_report.md) · [tuning_report.md](reports/tuning_report.md) |
| Calibration and threshold | [calibration_report.md](reports/calibration_report.md) · [threshold_report.md](reports/threshold_report.md) |
| Freeze and provenance | [model_freeze_report.md](reports/model_freeze_report.md) · [decision_policy.json](reports/decision_policy.json) |
| Final evaluation and errors | [holdout_evaluation_report.md](reports/holdout_evaluation_report.md) · [error_analysis_report.md](reports/error_analysis_report.md) |
| Explainability | [model_interpretation_report.md](reports/model_interpretation_report.md) |
| Serving and monitoring | [serving_report.md](reports/serving_report.md) · [monitoring_report.md](reports/monitoring_report.md) |
| Interactive product | [portfolio_product_report.md](reports/portfolio_product_report.md) |
| Independent reproduction | [02_academic_delivery.ipynb](notebooks/02_academic_delivery.ipynb) |

Machine-readable records for every experiment live in
[`reports/experiments/`](reports/experiments); 58 generated figures live in
